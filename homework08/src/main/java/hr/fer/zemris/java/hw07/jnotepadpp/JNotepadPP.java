...
public final class JNotepadPP extends JFrame {
	...
	private JNotepadPP() {
		...
		setTitle("Untitled document - JNotepad++");
		initGUI();
		pack();
	}
	...
	private void initGUI() {
		...
		JMenuBar menu = new MenuBar(actionMap);
	...
	private void initializeActions() {
		Action createNew = new CreateNew(this);

		createNew.putValue(Action.SHORT_DESCRIPTION,
		...
		Action open = new Open(this);

		open.putValue(Action.SHORT_DESCRIPTION, "Open a file");
		open.putValue(Action.ACCELERATOR_KEY, KeyStroke.getKeyStroke(
				KeyEvent.VK_O, InputEvent.CTRL_DOWN_MASK));

		actionMap.put("open", open);

		Action save = new Save(this);

		save.putValue(Action.SHORT_DESCRIPTION, "Save the current file");
		save.putValue(Action.ACCELERATOR_KEY, KeyStroke.getKeyStroke(
				KeyEvent.VK_S, InputEvent.CTRL_DOWN_MASK));
		actionMap.put("save", save);

		Action saveAs = new SaveAs(this);

		saveAs.putValue(Action.SHORT_DESCRIPTION, "Save the current file as...");
		saveAs.putValue(
		...
		Action copy = new Copy(this);

		copy.putValue(Action.SHORT_DESCRIPTION, "Copy the selection");
		copy.putValue(Action.ACCELERATOR_KEY, KeyStroke.getKeyStroke(
				KeyEvent.VK_C, InputEvent.CTRL_DOWN_MASK));
		actionMap.put("copy", copy);

		Action paste = new Paste(this);
		paste.putValue(Action.SHORT_DESCRIPTION, "Paste the clipboard");
		...
		Action cut = new Cut(this);
		cut.putValue(Action.SHORT_DESCRIPTION, "Cut the selection");
		cut.putValue(Action.ACCELERATOR_KEY, KeyStroke.getKeyStroke(
				KeyEvent.VK_X, InputEvent.CTRL_DOWN_MASK));
		actionMap.put("cut", cut);

		Action stats = new Statistic(this);
		stats.putValue(Action.SHORT_DESCRIPTION, "Dislay statistical info");
		...
		Action close = new AbstractAction("Close tab") {

			private static final long serialVersionUID = 3075498794762563983L;
		...
		close.putValue(Action.SHORT_DESCRIPTION, "Close the current file");
		...
		quit.putValue(Action.SHORT_DESCRIPTION, "Quit the program");
